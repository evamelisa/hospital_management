    ...
    <td>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editCategory_<?= $dokter['dokter_id']; ?>">
                    <i class="bx bx-edit-alt me-2"></i> Edit
                </a>
                <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deleteCategory_<?= $dokter['dokter_id']; ?>">
...
<div class="modal fade" id="deleteCategory_<?= $dokter['dokter_id']; ?>" tabindex="-1" aria-hidden="true">
...
<div id="editCategory_<?= $dokter['dokter_id']; ?>" class="modal fade" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="proses_kategori.php" method="POST">
          ...
          <div class="form-group">
            ...
            <input 
              ...
              class="form-control" 
            >
             <label for="spesialisasi">spesalis</label>
            <!-- Input untuk nama kategori -->
            <input 
              type="text" 
