...
if (isset($_POST['simpan'])) {
    ...
    if ($conn->query($query) === TRUE) {
        ...
        $_SESSION['notification'] = [
            'type' => 'danger',
            'message' => 'Gagal menambahkan pertemuan ' . $conn->error
        ];
    }
...
if (isset($_POST['delete'])) {
    ...
    if ($exec) {
        $_SESSION['notification'] = [
            'type' => 'primary',
            'message' => 'Pertemuan berhasil di hapus.'
        ];
    } else {
        $_SESSION['notification'] = [
            'type' => 'danger',
            'message' => 'Gagal menghapus pertemuan: ' . mysqli_error($conn)
        ];
    }
